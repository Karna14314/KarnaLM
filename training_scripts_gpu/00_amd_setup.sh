...
export TORCH_ATTENTION_BACKEND=MATH
...
echo "✓ pip upgrade skipped (managed by system)"
echo "✓ pip upgraded"
echo ""
...
mkdir -p /data
ln -sfn /mnt/scratch/data /data/raw
echo "✓ Symlinked /mnt/scratch/data to /data/raw"
