...
BASE_MODEL_PATH = "/data/checkpoints/karnalm-pretrain/hf_model"
TOK_PATH        = "/data/tokenizer/karnalm_tokenizer.json"
SFT_CKPT_DIR    = "/data/checkpoints/karnalm-sft"
...
final_path = f"{SFT_CKPT_DIR}/karnalm-1.1B-chat"
...
║     huggingface-cli upload KarnaDigital/KarnaLM-1.1B-chat \\    ║
║       {final_path}                                               ║
╚══════════════════════════════════════════════════════════════════╝
""")
